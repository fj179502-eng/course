      ...
      <div class="container-fluid" align="center"><br/>
        <div class="col-md-5">
          <div class="card card-primary" style="border: solid;border-radius: 5px;">
            ...
            <form method="post">
            <div class="col-md-12">
              <label style="float: left;">Add Enrollment</label>
              <input type="text" required name="enrollment1" class="form-control" placeholder="Enter...">
            </div><!--col div-->
              <div class="col-md-12">
              <label style="float: left;">Enrollment Scheme</label>
               <input type="text" required name="scheme1" class="form-control" placeholder="Enter...">
        ...
        <?php
         if(isset($_POST['btn'])){
            $q=mysqli_query($conn,"INSERT INTO `enrollment`(`enrollment`, `enrollment-scheme`) VALUES ('".$_POST['enrollment1']."','".$_POST['scheme1']."')");
            if($q>0){
                ?>
                <script type="text/javascript">
                  window.location="view-enrollment.php";
                </script>
                <?php
            }
         }
