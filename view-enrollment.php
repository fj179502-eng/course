       ...
       <div class="col-md-12">
         <div class="card card-primary">
           <div class="card-header">
             <h3 align="center">View Enrollment</h3>
           </div>
           <div class="card-body">
             <table id="example1" class="table table-bordered table-striped">
               <thead>
                 <th>Sno#</th>
                 <th>Enrollment</th>
                 <th>Enrollment Scheme</th>
                 <th>Active</th>
               </thead>
               <tbody>
                 <?php
                $q=mysqli_query($conn,"SELECT * FROM enrollment WHERE is_active=1");
                $s=0;
                ...
                $s++;
                 ...
                 <tr>
                   ...
                   <td><?php echo $row['enrollment-scheme']?></td>
                   <td><a href="enrollment-profile.php?cid=<?php echo $row['course_id']?>" class="btn btn-primary">View</a>
                        <a href="update-enrollment.php?cid=<?php echo $row['course_id']?>" class="btn btn-success">Update</a>
                        <a href="delete-enrollment.php?stdid=<?php echo $row['course_id']?>" class="btn btn-danger">Delete</a>
